...
const Hero = () => {
  return (
    ...
    <section className=" w-full flex  max-lg:flex-col flex-row justify-center items-center gap-10 max-continer min-h-screen border-2 pt-28">
      <div className="  flex flex-col  max-lg:justify-center px-4 ">
        ...
        <h1 className="mt-10 font-palanquin text-4xl text-blue-950 max-sm:text-[62px] max-sm:leading-[72px] font-bold">
          <span className="no-wrap text-green-900">Turn Waste Product <br />To Cash</span>
        </h1>
        <p className="text-base leading-8 mt-6 mb-7 sm:max-w-sm font-montserrat text-slate-gray"> We are your one-stop destination for all your waste management solution. Our website offers a wide array of services, if you have some waste to dispose or need some waste product material for use , we got you sorted . </p>
